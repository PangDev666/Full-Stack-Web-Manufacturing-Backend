...
export default function Plant({
  ...
  plantcategory: existingPlantcategory,
  tags: existingTags,
  ...
  async function createPlant(ev) {
    ...
    if (_id) {
      await axios.put("/api/plants", { ...data, _id });
  ...
  return (
    <>
      <form className="addWebsiteform" onSubmit={createPlant}>
        {/* Plant Title */}
        ...
        <div className="w-100 flex flex-col flex-left mb-2">
          ...
          >
            ...
            <option value="Chachoengsao Main Factory">
              Chachoengsao Main Factory
            </option>
            <option value="Chachoengsao Felt Plant">
              Chachoengsao Felt Plant
            </option>
            <option value="Chachoengsao Rubber Plant">
              Chachoengsao Rubber Plant
            </option>
            <option value="Ban Bueng Plant">Ban Bueng Plant</option>
          </select>
        </div>
        ...
        <div className="description w-100 flex flex-col flex-left mb-2">
          <label htmlFor="description">
            Plant Content (for image: first upload and copy link and paste in
            ![alt text](link))
          </label>
          <MarkdownEditor
            value={description}
